...
namespace backend_grade_pro.src.controller
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            var user = await _context.Users.FirstOrDefaultAsync(u => u.identity_user == loginDto.Identity);
        ...
        {
            var user = await _context.Users.FirstOrDefaultAsync(u => u.identity_user == forgotPasswordDto.Identity);
            if (user == null)
            {
                return NotFound();
            }
        ...
        {
            var user = await _context.Users.FirstOrDefaultAsync(u => u.identity_user == forgotUserDto.Identity);
            if (user == null)
            {
                return NotFound();
            }
